...
#SBATCH -J short_filter
#SBATCH -o short_filter_%j.o
#SBATCH -e short_filter_%j.o
#SBATCH --mem=60000
#SBATCH -t 2-00:00
#SBATCH -N 1
#SBATCH -n 23
...
my_out="ph_shorthic_aligned.bam"
my_mat="/home/eoziolor/program/matlock/bin/matlock"
my_qc_file="short_filt_qc"
my_filt="ph_short_filtered.bam"
